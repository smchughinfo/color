...
namespace Color
{
   public partial class Form1 : Form
   {
      ...
      {
         var curPointerColor = RgbToLab(color.R, color.G, color.B);
         double minDistance = double.MaxValue;
         int minIndex = 0;

         for(int i = 0; i < names.Length; i++)
         {
            var curNamedColorRgb = System.Drawing.Color.FromArgb(r[i], g[i], b[i]);
            ...
            if(minDistance > curDistance)
            {
               ...
               minIndex = i;
               namedColorRGB = curNamedColorRgb; // todo this doesnt get returned the way other things do.
            }
         }

         return names[minIndex] + System.Environment.NewLine + "(" + r[minIndex] + "," + g[minIndex] + "," + b[minIndex] + ")";
      }

      private double GetDistance(double l1, double l2, double a1, double a2, double b1, double b2)
      {
         return Math.Sqrt(
            Math.Pow(l1-l2,2) +
            Math.Pow(a1-a2,2) +
      ...
      private void UpdateForm()
      {
         ...
         string hex = "#" + Snippets00002.ColorToHexString(color);
         lblHex.Text = hex;
      ...
      private void UpdateMixer()
      {
         ...
         string hex = Snippets00002.ColorToHexString(mixColor);
         if (hex.Length == 6)
         {
