...
namespace CSharpColorSpaceConverter
{
    public static class ColorSpaceConverter
    {
        ...
        /*public static double[] RGBToHSL(int r, byte g, byte b)
        {

        }*/

        public static double[] RGBToHSL(byte R, byte G, byte B)
        {
            float _R = (R / 255f);
            float _G = (G / 255f);
            float _B = (B / 255f);
        ...
        public static double[] RGBToHSV(int r, int g, int b)
        {
            ...
            var H = System.Drawing.Color.FromArgb(255, r, g, b).GetHue();
